...
const pages=['index.html','versions/old.html','versions/change1.html','versions/change2.html','versions/review2.html'];
const failures=[];
...
if(failures.length){console.error(failures);process.exit(1);}console.log('PASS: 5 pages, local assets, page anchors, and all preserved version hashes.');
